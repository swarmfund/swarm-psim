...
type StateUpdate struct {
	...
	AccountBlockReasons *StateAccountBlockReasonsUpdate
	AccountType         *StateAccountTypeUpdate
}

type StateAccountBlockReasonsUpdate struct {
	Address      string
	BlockReasons uint32
}

type StateAccountTypeUpdate struct {
	Address     string
