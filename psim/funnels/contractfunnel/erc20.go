...
//
// Solidity: function approveAndCall(spender address, value uint256, extraData bytes) returns(bool)
func (_ERC20 *ERC20Transactor) ApproveAndCall(opts *bind.TransactOpts, spender common.Address, value *big.Int, extraData []byte) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "approveAndCall", spender, value, extraData)
}

// ApproveAndCall is a paid mutator transaction binding the contract method 0xcae9ca51.
//
// Solidity: function approveAndCall(spender address, value uint256, extraData bytes) returns(bool)
func (_ERC20 *ERC20Session) ApproveAndCall(spender common.Address, value *big.Int, extraData []byte) (*types.Transaction, error) {
	return _ERC20.Contract.ApproveAndCall(&_ERC20.TransactOpts, spender, value, extraData)
}

// ApproveAndCall is a paid mutator transaction binding the contract method 0xcae9ca51.
//
// Solidity: function approveAndCall(spender address, value uint256, extraData bytes) returns(bool)
func (_ERC20 *ERC20TransactorSession) ApproveAndCall(spender common.Address, value *big.Int, extraData []byte) (*types.Transaction, error) {
	return _ERC20.Contract.ApproveAndCall(&_ERC20.TransactOpts, spender, value, extraData)
}
