...
func ValidExtractedItem(currentOp xdr.Operation, sourceAccount xdr.AccountId, opLedgerChanges []xdr.LedgerEntryChange, opResultTr xdr.OperationResultTr, txTime time.Time, pagingToken string) ExtractedItem {
	return ExtractedItem{OpData{Op: currentOp, SourceAccount: sourceAccount, OpLedgerChanges: opLedgerChanges, OpResult: opResultTr, CreatedAt: txTime, PagingToken: pagingToken}, nil}
}
